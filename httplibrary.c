        ...
        sem_wait(&ghSemaphore);
            ...
            while(1) {
                ...
                thread[current_thread_id] = (http_thread){
                    .client = &client[current_thread_id],
                    .callback = callback,
                    .selected_thread_room = &thread_room[current_thread_id],
                    #ifdef _WIN32
                    .thread_handle = CreateThread(0, 0, http_handle_client, &thread[current_thread_id], 0, NULL),
                    #else
                    .thread_handle = NULL,
                    #endif
                    .req_raw_data = {0}
